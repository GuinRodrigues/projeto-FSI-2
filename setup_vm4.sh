...
# 2. Criar diretoria da CA e base de dados
...
# 7. Certificado do Cliente VPN e Empacotamento P12 para o Browser
...
# 8. Iniciar OCSP Responder (comando bloqueante — fica em execução até Ctrl+C)
echo ""
echo "==> A iniciar o respondedor OCSP na porta 8080. Usa Ctrl+C para parar."
